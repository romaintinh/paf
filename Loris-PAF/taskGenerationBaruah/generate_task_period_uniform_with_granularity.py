...
def generate_1000_times( period_min, period_max,utilization_min, utilization_max, ratio_min, ratio_max, probability_hi_task, utilization_limit, path_to_write_task_files, nb_processor,period_granularity):
    ...
    for i in range(0,1000):
        ...
        while utilization_lo < utilization_limit and utilization_hi_hi < utilization_limit:
            ...
            period_list.extend(parameter_generating_function.task_period_uniform_with_granularity(period_min,period_max,period_granularity,1))
...
if  __name__ == '__main__':
    ...
    generate_1000_times(period_min, period_max, utilization_min, utilization_max,ratio_min, ratio_max, probability_hi_task, utilization_limit, path_to_write_task_files,nb_processor, period_granularity)
