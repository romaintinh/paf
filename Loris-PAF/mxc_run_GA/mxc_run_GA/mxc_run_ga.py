...
if len(sys.argv) > 2:
	...
	file_path_result = task_file_path+"_result_ga.txt"
...
if nb_hi_tasks == 0 or nb_lo_tasks == 0:
	task_file_path_modal_server = task_file_path+"_modal_server_allocation_ga.txt"
...
def main():
	...
	if mxc_run_ga_utils.Check_best_ind_fitness(best_ind.fitness.values) == True:
		...
		best_individual_generation_file_statistics = file_task_path_directory_hierarchy[:-1]+"_best_individual_statistics_ga.csv"
